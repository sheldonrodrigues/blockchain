					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Manage Data Destruction",
									"targetURL": "#destruction-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"destruction-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=destruction",
									"url": sap.ui.require.toUrl("destruction")
								}
							}
						}
					}
